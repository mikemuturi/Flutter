// import 'package:city_foods/vendor/pages/profiles.dart';
// import 'package:flutter/material.dart';

// void main() {
//   runApp(MaterialApp(home: StackedProfileCardPage()));
// }

// class StackedProfileCardPage extends StatelessWidget {
//   const StackedProfileCardPage({super.key});
...
//         orders: ['Order ${index + 1} - Item A', 'Order ${index + 1} - Item B'],
//       ),
//     );

//     return Scaffold(
//       appBar: AppBar(title: Text("Profile Stack")),
//       body: Center(
//         child: Card(
//           elevation: 10.0,
//           shape:
...
//                 Expanded(
//                   flex: 2,
//                   child: ProfileInfo(profiles: profiles),
//                 ),
//               ],
//             ),
//           ),
...
//       children: [
//         for (var i = 0; i < 5; i++) // Adjusted to 5 profiles
//           Positioned(
//             left: i * 30.0,
//             child: CircleAvatar(
//               radius: 28,
...
//               child: Text(
//                 '+${7 - 5}', // Using a static count for demonstration
//                 style:
...
//   ProfileInfo({required this.profiles});
...
//               context,
//               MaterialPageRoute(
//                 builder: (context) => ProfileDetailsPage(profiles: profiles),
//               ),
//             );
//           },
